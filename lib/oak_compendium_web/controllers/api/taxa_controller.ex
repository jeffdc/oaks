defmodule OakCompendiumWeb.API.TaxaController do
  @moduledoc """
    ...
    responses: [
      ok:
        {"Taxa list", "application/json",
         %OpenApiSpex.Schema{
           type: :array,
           items: OakCompendiumWeb.Schemas.Taxon
         }}
    ]
  )
  ...
  operation(:show,
    ...
    responses: [
      ok: {"Taxon", "application/json", OakCompendiumWeb.Schemas.Taxon},
      bad_request: {"Invalid level", "application/json", OakCompendiumWeb.Schemas.Error},
