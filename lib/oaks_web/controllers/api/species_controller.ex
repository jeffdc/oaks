defmodule OaksWeb.API.SpeciesController do
  @moduledoc """
  ...
  operation(:index,
    ...
    responses: [
      ok: {"Species list", "application/json", OaksWeb.Schemas.SpeciesListResponse}
    ]
  )
  ...
  operation(:show,
    ...
    responses: [
      ok: {"Species", "application/json", OaksWeb.Schemas.Species},
  ...
  operation(:full,
    ...
    responses: [
      ok: {"Species full", "application/json", OaksWeb.Schemas.SpeciesFull},
      not_found: {"Not found", "application/json", OaksWeb.Schemas.Error}
    ]
  )
  ...
  operation(:search,
    ...
    responses: [
      ok: {"Search results", "application/json", OaksWeb.Schemas.SpeciesListResponse}
    ]
  )
