<script>
  import { allSpecies, speciesCounts, getPrimarySource } from './dataStore.js';
  import { onMount } from 'svelte';

  export let onSelectSpecies;
  export let onBrowseList;
  export let onBrowseTaxonomy;
  ...
  function handleFeaturedClick() {
    if (featuredSpecies) {
      onSelectSpecies(featuredSpecies);
    }
  }
</script>
...
<div class="landing-page">
  ...
  {#if featuredSpecies}
    <section class="featured-section">
      ...
      <button class="featured-card" on:click={handleFeaturedClick}>
  ...
  <section class="browse-section">
    ...
    <div class="browse-options">
      <button class="browse-card" on:click={onBrowseList}>
      ...
      <button class="browse-card" on:click={onBrowseTaxonomy}>
        <div class="browse-icon">
          <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
