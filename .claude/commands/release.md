...
2. **CI has passed** (the "CI" workflow)
3. **Deploy has completed** (the "Deploy" workflow, triggered automatically by CI)
...
**Full Changelog**: https://github.com/jeffdc/oaks/compare/<previous-tag>...<new-tag>
```
